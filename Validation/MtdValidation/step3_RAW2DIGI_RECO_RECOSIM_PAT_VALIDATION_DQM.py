...
process.source = cms.Source("PoolSource",
    #fileNames = cms.untracked.vstring('file:/eos/user/p/pakrap/MTD/CMSSW_15_0_0_pre2/src/Validation/MtdValidation/29706.0_SinglePiFlatPt0p7To10+Run4D110/1000evt/step2.root'),
    fileNames = cms.untracked.vstring('file:/eos/cms/store/relval/CMSSW_15_0_0/RelValSinglePiFlatPt0p7To10/GEN-SIM-DIGI-RAW/PU_141X_mcRun4_realistic_v3_STD_Run4D110_PU-v3/2580000/3073177e-2d47-41cf-aa0e-955919e7498e.root'),
...
process.reconstruction_step += process.mtdMergedClusters
...
process.FEVTDEBUGHLToutput.fileName = cms.untracked.string('file:/tmp/pakrap/PU/step3.root')
process.FEVTDEBUGHLToutput.outputCommands.append('keep *_mtdMergedClusters_*_*')