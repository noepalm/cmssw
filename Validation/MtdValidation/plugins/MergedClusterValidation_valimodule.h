#ifndef Validation_MtdValidation_MergedClusterValidation_valimodule_h
#define Validation_MtdValidation_MergedClusterValidation_valimodule_h
...
class MergedClusterValidation_valimodule : public DQMEDAnalyzer {
public:
    explicit MergedClusterValidation_valimodule(const edm::ParameterSet&);
    ~MergedClusterValidation_valimodule() = default;
